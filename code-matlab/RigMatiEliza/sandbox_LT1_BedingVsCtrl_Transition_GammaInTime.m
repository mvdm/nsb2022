...
for i=1:6
    ...
    Prep=pos.tvec>pos.tvec(indxsp(1)) & pos.tvec<pos.tvec(indxsp(2));
    Transp=pos.tvec>pos.tvec(indxsp(3)) & pos.tvec<pos.tvec(indxsp(4));
    Postp=pos.tvec>pos.tvec(indxsp(5)) & pos.tvec<pos.tvec(indxsp(6));
...
% low-gamma
datalg = bandpass(csc.data(Trans),f_lg,Fs); % 
...
% plot(csc.tvec(Trans),datalg./max(datalg),'r','Linewidth',2)
hold on
plot(pos.tvec(Transp),pos.data(2,Transp)./max(pos.data(2,Transp)),'k','Linewidth',2)
